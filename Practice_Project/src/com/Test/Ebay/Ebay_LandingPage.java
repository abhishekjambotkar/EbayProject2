...
public class Ebay_LandingPage {
	...
	public boolean MoveToSigningPage(AndroidDriver driver) throws InterruptedException{
	...
	public boolean TapOnSearchBox(AndroidDriver driver) throws InterruptedException{

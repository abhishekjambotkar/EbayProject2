...
public class TestProject {
		...
		Ebay_LandingPage ebay_LandingPage = new  Ebay_LandingPage();
		Ebay_SignInPage ebay_SignInPage = new Ebay_SignInPage();
		Ebay_SignInConfirmationPage ebay_SignInConfirmationPage = new Ebay_SignInConfirmationPage();
		Ebay_SearchScreen ebay_SearchScreen = new Ebay_SearchScreen();
		Ebay_SearchResultsPage ebay_SearchResultsPage = new Ebay_SearchResultsPage();
		Ebay_SearchedOptionPage ebay_SearchedOptionPage = new Ebay_SearchedOptionPage();
		Ebay_ReviewPage ebay_ReviewPage = new Ebay_ReviewPage();
		Ebay_CheckoutScreen ebay_CheckoutScreen = new Ebay_CheckoutScreen();
